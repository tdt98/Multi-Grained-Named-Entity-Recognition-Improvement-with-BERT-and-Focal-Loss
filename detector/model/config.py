...
class Config():
    ...
    # bert file
    bertfile_dev = data_pre + dataset + "/bert/bert_dev.hdf5"
    bertfile_train = data_pre + dataset + "/bert/bert_train.hdf5"
    bertfile_test = data_pre + dataset + "/bert/bert_test.hdf5"
